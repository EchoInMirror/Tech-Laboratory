...
execute as @e[tag=TechLab.portal,tag=!TechLab.Debug.mark] at @s unless predicate techlaboratory:portal_done run function techlaboratory:portal/door_integrity
